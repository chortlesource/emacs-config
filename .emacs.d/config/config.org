...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'emacs-startup-hook
            (lambda() (sr-speedbar-open)))
#+END_SRC

* 6. Development

To utilise emacs effectively as a development environment I utilise
the following packages which enable me to write and compile code
within emacs.

** 6.1 CEDET

CEDET assist with code completion. I'm not entirely sure I like this
but I've added it for now and we will see how effective it actually is.
...
(setq ede-custom-file (expand-file-name "config/cc-mode-projects.el" user-emacs-directory))
